 ...
 */
final class Version20220712122503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE station (id INT AUTO_INCREMENT NOT NULL, status TINYINT(1) NOT NULL, tour_order VARCHAR(3) DEFAULT NULL, reference VARCHAR(50) DEFAULT NULL, name VARCHAR(150) NOT NULL, address VARCHAR(255) NOT NULL, zip VARCHAR(5) NOT NULL, city VARCHAR(50) NOT NULL, lat VARCHAR(50) DEFAULT NULL, lng VARCHAR(50) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, main_picture VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
